          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="flex items-center gap-4 mb-4">
                  <CurrencyConverter inrPrice={item.price} className="text-2xl font-bold" />
                  {item.originalPrice && (
                    <CurrencyConverter inrPrice={item.originalPrice} className="text-lg text-gray-500 line-through" />
                  )}
